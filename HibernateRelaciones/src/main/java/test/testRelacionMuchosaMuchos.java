...
public class testRelacionMuchosaMuchos {
	...
	public static void insertarPersonas() {
		...
		Dni dni1 = new Dni("1", new GregorianCalendar(2020, 12, 1).getTime(),
				new GregorianCalendar(2020, 12, 1).getTime(), "Juan", "María");

		Direccion direccion1 = new Direccion("Abc", "12 A", "Córdoba", 14000);
		...
		Direccion direccion2 = new Direccion("Abc", "12 A", "Córdoba", 14000);
	...
	public static void borrarPersona() {
		...
		//Desvincular. Para ello congemos cada factura y eliminamos su relación con Persona		
		p1.setTitulos(null);
