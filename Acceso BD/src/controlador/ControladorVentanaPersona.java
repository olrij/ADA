...
public class ControladorVentanaPersona implements ActionListener {
    ...
    private void agregarPersona() {
        ...
        String genero = JOptionPane.showInputDialog("Género (M/F):");
    ...
    private void editarPersona() {
        ...
        if (filaSeleccionada >= 0) {
            ...
            String nuevoGenero = JOptionPane.showInputDialog("Nuevo género (M/F):", tableModel.getValueAt(filaSeleccionada, 2));
    ...
    private void eliminarPersona() {
        ...
        if (filaSeleccionada >= 0) {
            int id = Integer.parseInt((String) tableModel.getValueAt(filaSeleccionada, 0));
            int confirmacion = JOptionPane.showConfirmDialog(vista, "¿Estás seguro de eliminar esta persona?", "Confirmación", JOptionPane.YES_NO_OPTION);
