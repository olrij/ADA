package com.example.apirest.prueba.controller;
...
import com.example.apirest.prueba.service.PersonaService;
import com.example.apirest.prueba.service.PersonaServiceImpl;
...
public class PersonaController {
    ...
    public ResponseEntity<?> delete(@PathVariable(value = "id") Integer personaId) {
        ...
        return ResponseEntity.ok().build(); // Mandamos un OK
